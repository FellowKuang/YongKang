...
namespace 中车
{
    ...
    public partial class ccqjlkz : Form
    {
        ...
        public static bool addDataTag = true, sleepTag=false, btnPasueTag=false, btnContinueTag=false;
        ...
        Thread Listen_Thread, recDataThread, calSval, dealD;
        ...
        {
            //Console.WriteLine("listenThread={0}", AppDomain.GetCurrentThreadId().ToString());
            // Socket listenSocket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            listenSocket.Bind(new IPEndPoint(IPAddress.Any, 8087));
            listenSocket.Listen(100);
            rtbLog.AppendText("正在连接8087端口...");
