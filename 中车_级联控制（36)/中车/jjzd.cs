...
namespace 中车
{
    public partial class jjzd : Form
    {
        ...
        public void dbSave()
        {
            ...
            //查询表格中已有数据行数
            string countRow = "select count(*) from jjzd_pressure";
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                if (row.Cells[0].Value != null)
                {
                    ...
                    string INS = @"insert into jjzd_pressure (id,time,pressure001,pressure002,pressure003,pressure004,pressure005) values 
